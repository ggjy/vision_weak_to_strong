...
class MobileNetV2(nn.Module):
    ...
    def stage_info(self, stage):
        if stage == 1:
            index = 0
            shape = (self.stage_channels[0], 16, 16)
        elif stage == 2:
            index = 1
            shape = (self.stage_channels[1], 16, 16)
        elif stage == 3:
            index = 2
            shape = (self.stage_channels[2], 8, 8)
        elif stage == 4:
            index = 3
            shape = (self.stage_channels[3], 4, 4)
        elif stage == 5:
            index = 4
            shape = (self.stage_channels[4], 2, 2)
        elif stage == -1:
            index = -1
            shape = 1280
        else:
            raise RuntimeError(f'Stage {stage} out of range (1-5)')
...
@register_model
def cifar_mobilenetv2(num_classes, **kwargs):
