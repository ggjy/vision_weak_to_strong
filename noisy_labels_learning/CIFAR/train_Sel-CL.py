...
def main(args):
    ...
    exp_path = os.path.join(args.out, 'noise_models', exp_name, args.noise_type, str(args.noise_ratio))
    res_path = os.path.join(args.out, 'metrics', exp_name, args.noise_type, str(args.noise_ratio))
