...
def PreActResNet34(num_classes, low_dim, head, normlinear=False):
    return ResNet(PreActBlock, [3, 4, 6, 3], head=head, num_classes=num_classes, low_dim=low_dim, normlinear=normlinear)
...
def ResNet34(num_classes, low_dim, head, normlinear=False):
    return ResNet(BasicBlock, [3, 4, 6, 3], head=head, num_classes=num_classes, low_dim=low_dim, normlinear=normlinear)


def ResNet50(num_classes, low_dim, head, normlinear=False):
    return ResNet(Bottleneck, [3, 4, 6, 3], head=head, num_classes=num_classes, low_dim=low_dim, normlinear=normlinear)


def ResNet101(num_classes, low_dim, head, normlinear=False):
    return ResNet(Bottleneck, [3, 4, 23, 3], head=head, num_classes=num_classes, low_dim=low_dim, normlinear=normlinear)


def ResNet152(num_classes, low_dim, head, normlinear=False):
    return ResNet(Bottleneck, [3, 8, 36, 3], head=head, num_classes=num_classes, low_dim=low_dim, normlinear=normlinear)
